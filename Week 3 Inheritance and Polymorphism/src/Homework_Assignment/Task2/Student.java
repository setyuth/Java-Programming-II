package Homework_Assignment.Task2;

import Homework_Assignment.Person;
...
public class Student extends Person {
    ...
    // 3. Overloaded with course name and grade
    public void addCredits(int credits, String courseName, char grade) {
        if (credits > 0) {
            this.creditsCompleted += credits;
            System.out.println("Completed course: " + courseName + " with Grade: " + grade);
            System.out.println("Added " + credits + " credits. Total: " + creditsCompleted);
            // Optional: You could add logic here to update GPA based on the grade!
        }
    }
